...
# DEFAULT-NEXT:    leaq -0x3fffeff5(%rip), %rax # 0xffffffffc020216b <a+0xffffffffc0000000>
# DEFAULT: <func_2>:
# DEFAULT-NEXT:    nop
...
# DEFAULT-NEXT:    leaq 0x40001001(%rip), %rax # 0x4020216b <a+0x40000000>
# DEFAULT: <func_4>:
# DEFAULT-NEXT:    nop
...
# JUSTHUGE-NEXT:    leaq -0x3fffeff3(%rip), %rax # 0xffffffffc020216c <a+0xffffffffc0000000>
# JUSTHUGE: <func_1>:
# JUSTHUGE-NEXT:    nop
# JUSTHUGE: <func_2>:
# JUSTHUGE-NEXT:    nop
...
# JUSTHUGE-NEXT:    leaq 0x40001000(%rip), %rax # 0x4020216c <a+0x40000000>
...
# SYMORDERING-NEXT:    leaq -0x3fffeff5(%rip), %rax # 0xffffffffc020216b <a+0xffffffffc0000000>
# SYMORDERING: <func_1>:
# SYMORDERING-NEXT:    nop
# SYMORDERING: <func_2>:
# SYMORDERING-NEXT:    nop
...
# SYMORDERING-NEXT:    leaq 0x40001000(%rip), %rax # 0x4020216b <a+0x40000000>
