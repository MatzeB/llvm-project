...
// CHECK-LABEL: define dso_local void @hd_function_a
extern "C"
...
// CHECK-LABEL: define dso_local void @hd_function_b
extern "C"
__host__ __device__ void hd_function_b(bool b) { if (b) host_function(); }

// CHECK-LABEL: define dso_local void @device_function_b
extern "C"
__device__ void device_function_b() { hd_function_b(false); }

// CHECK-LABEL: define dso_local void @global_function
extern "C"
...
// CHECK: !{{[0-9]+}} = !{{{.*}} @global_function, !"kernel", i32 1}
// facebook end
