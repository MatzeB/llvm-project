...
struct FileRecord {
  ...
  static constexpr clang::FileEntry const *kInvalidFileEntry{nullptr};
  ...
  clang::FileEntry const *thisFileEntry;
  ...
  FileRecord(size_t index, clang::FileEntry const *entry);
  ...
  bool isRealFile() const { return thisFileEntry != kInvalidFileEntry; }
};
...
public:
  ...
  FileRecord &addFile(clang::FileEntry const *FID);
  ...
  clang::FileEntry const *getMainFileEntry() const;
  clang::FileEntry const *fileEntryOf(clang::FileID FID) const;
  clang::FileEntry const *fileEntryOf(clang::SourceLocation Loc) const;
  clang::FileEntry const *fileEntryOf(clang::PresumedLoc Loc) const;
  ...
  void onInclude(clang::SourceLocation IncludeLoc,
                 clang::FileEntry const *IncludedFileEntry,
