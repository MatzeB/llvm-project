...
# Unblock autorebaser: current command is not playing nice with NFC checker,
# so disaable it
# UN: not llvm-bolt %t.exe -o %t.bolt.8 --pad-funcs-before=_start:1 2>&1 | FileCheck --check-prefix=CHECK-BAD-ALIGN %s
