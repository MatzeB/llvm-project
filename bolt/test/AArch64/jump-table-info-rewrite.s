## Check that AArch64 jump tables described in .llvm_jump_table_info are
## rewritten with the correct encoding after basic block reordering.
##
## This uses format 3 (2-byte unsigned entries, shifted by 2) and verifies that
## BOLT updates emitted jump table data to match the new block layout.
...
# RODATA-NEXT: 0x{{[0-9a-f]+}} 0c000900 0500
...
.LJTI0_0:
  ...
  .byte 3                               // format 3: 2-byte unsigned, shr 2
