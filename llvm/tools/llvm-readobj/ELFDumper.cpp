...
template <class ELFT> void GNUELFDumper<ELFT>::printSectionHeaders() {
  ...
  OS << "There are " << to_string(Sections.size())
     << " section headers, starting at offset " << "0x"
...
void GNUELFDumper<ELFT>::printGNUVersionSectionProlog(
  ...
  OS << Label << " section '" << SecName << "' " << "contains " << EntriesNum
     << " entries:\n";
...
template <class ELFT> void GNUELFDumper<ELFT>::printAddrsig() {
  ...
  OS << "\nAddress-significant symbols section '" << Name << "'" << " contains "
     << SymsOrErr->size() << " entries:\n";
  OS << "   Num: Name\n";
