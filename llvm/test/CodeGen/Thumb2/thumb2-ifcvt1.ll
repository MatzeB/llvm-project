...
; RUN: llc < %s -mtriple=thumbv7-apple-darwin | FileCheck %s --check-prefixes=V01
; RUN: llc < %s -mtriple=thumbv7-apple-darwin -arm-default-it | FileCheck %s --check-prefixes=V01
; RUN: llc < %s -mtriple=thumbv8 | FileCheck %s --check-prefixes=V23,V2
; RUN: llc < %s -mtriple=thumbv8 -enable-tail-merge=0 | FileCheck %s --check-prefixes=V23,V3
...
; V01-NEXT:    ittee ne
; V01-NEXT:    cmpne r2, #7
; V01-NEXT:    addne r0, r1
; V01-NEXT:    addeq r0, r1
; V01-NEXT:    addeq r0, #1
; V01-NEXT:    bx lr
;
; V23-LABEL: t1:
...
; V23-NEXT:    ittee ne
; V23-NEXT:    cmpne r2, #7
; V23-NEXT:    addne r0, r1
; V23-NEXT:    addeq r0, r1
; V23-NEXT:    addeq r0, #1
; V23-NEXT:    bx lr
