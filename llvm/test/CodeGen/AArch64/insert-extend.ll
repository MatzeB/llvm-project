...
; CHECK-NEXT:    addp v16.4s, v3.4s, v2.4s
; CHECK-NEXT:    sub v7.4s, v1.4s, v7.4s
; CHECK-NEXT:    sub v2.4s, v2.4s, v4.4s
; CHECK-NEXT:    ext v4.16b, v16.16b, v16.16b, #8
; CHECK-NEXT:    zip1 v17.4s, v7.4s, v6.4s
; CHECK-NEXT:    sub v3.4s, v3.4s, v5.4s
; CHECK-NEXT:    zip1 v1.4s, v2.4s, v3.4s
; CHECK-NEXT:    zip2 v2.4s, v2.4s, v3.4s
; CHECK-NEXT:    uzp1 v5.4s, v4.4s, v0.4s
; CHECK-NEXT:    ext v3.16b, v7.16b, v17.16b, #8
; CHECK-NEXT:    mov v7.s[3], v6.s[2]
; CHECK-NEXT:    uzp2 v4.4s, v4.4s, v0.4s
; CHECK-NEXT:    addp v0.4s, v16.4s, v0.4s
; CHECK-NEXT:    mov v1.d[1], v3.d[1]
; CHECK-NEXT:    mov v2.d[1], v7.d[1]
; CHECK-NEXT:    sub v3.4s, v5.4s, v4.4s
; CHECK-NEXT:    rev64 v4.4s, v3.4s
; CHECK-NEXT:    add v5.4s, v2.4s, v1.4s
; CHECK-NEXT:    sub v1.4s, v1.4s, v2.4s
; CHECK-NEXT:    rev64 v2.4s, v0.4s
; CHECK-NEXT:    rev64 v6.4s, v5.4s
; CHECK-NEXT:    rev64 v16.4s, v1.4s
; CHECK-NEXT:    addp v7.4s, v0.4s, v5.4s
; CHECK-NEXT:    addp v17.4s, v3.4s, v1.4s
; CHECK-NEXT:    sub v3.4s, v3.4s, v4.4s
; CHECK-NEXT:    sub v0.4s, v0.4s, v2.4s
; CHECK-NEXT:    rev64 v4.4s, v7.4s
; CHECK-NEXT:    zip1 v21.4s, v7.4s, v7.4s
; CHECK-NEXT:    sub v1.4s, v1.4s, v16.4s
; CHECK-NEXT:    sub v5.4s, v5.4s, v6.4s
; CHECK-NEXT:    rev64 v18.4s, v17.4s
; CHECK-NEXT:    ext v2.16b, v3.16b, v17.16b, #8
; CHECK-NEXT:    ext v6.16b, v0.16b, v7.16b, #4
; CHECK-NEXT:    mov v19.16b, v5.16b
; CHECK-NEXT:    mov v20.16b, v1.16b
; CHECK-NEXT:    ext v4.16b, v4.16b, v5.16b, #8
; CHECK-NEXT:    ext v16.16b, v18.16b, v1.16b, #8
; CHECK-NEXT:    trn2 v0.4s, v21.4s, v0.4s
; CHECK-NEXT:    ext v18.16b, v2.16b, v3.16b, #4
; CHECK-NEXT:    mov v3.s[2], v17.s[1]
; CHECK-NEXT:    ext v6.16b, v6.16b, v6.16b, #4
; CHECK-NEXT:    mov v19.s[2], v7.s[3]
; CHECK-NEXT:    mov v20.s[2], v17.s[3]
; CHECK-NEXT:    ext v4.16b, v5.16b, v4.16b, #12
; CHECK-NEXT:    ext v1.16b, v1.16b, v16.16b, #12
; CHECK-NEXT:    uzp2 v2.4s, v2.4s, v18.4s
; CHECK-NEXT:    mov v5.16b, v3.16b
; CHECK-NEXT:    mov v21.16b, v6.16b
; CHECK-NEXT:    mov v16.16b, v19.16b
; CHECK-NEXT:    mov v18.16b, v20.16b
; CHECK-NEXT:    sub v6.4s, v0.4s, v6.4s
; CHECK-NEXT:    mov v5.s[1], v17.s[0]
; CHECK-NEXT:    mov v21.s[0], v7.s[1]
; CHECK-NEXT:    mov v16.s[1], v7.s[2]
; CHECK-NEXT:    mov v18.s[1], v17.s[2]
; CHECK-NEXT:    sub v3.4s, v3.4s, v2.4s
; CHECK-NEXT:    sub v7.4s, v20.4s, v1.4s
; CHECK-NEXT:    sub v17.4s, v19.4s, v4.4s
...
; CHECK-NEXT:    cmlt v3.8h, v2.8h, #0
; CHECK-NEXT:    cmlt v7.8h, v0.8h, #0
; CHECK-NEXT:    cmlt v5.8h, v1.8h, #0
