...
; CHECK-NEXT:    trn2 v17.4s, v2.4s, v1.4s
; CHECK-NEXT:    uzp2 v18.4s, v2.4s, v1.4s
; CHECK-NEXT:    mov v7.s[3], v0.s[2]
; CHECK-NEXT:    uzp2 v0.4s, v4.4s, v1.4s
...
; CHECK-NEXT:    uzp2 v2.4s, v18.4s, v2.4s
...
; CHECK-NEXT:    add v3.4s, v17.4s, v4.4s
...
; CHECK-NEXT:    sub v2.4s, v4.4s, v1.4s
; CHECK-NEXT:    add v1.4s, v1.4s, v4.4s
; CHECK-NEXT:    mov v5.d[1], v0.d[1]
; CHECK-NEXT:    mov v16.d[1], v3.d[1]
; CHECK-NEXT:    rev64 v6.4s, v1.4s
; CHECK-NEXT:    sub v3.4s, v3.4s, v5.4s
; CHECK-NEXT:    add v4.4s, v0.4s, v16.4s
; CHECK-NEXT:    rev64 v5.4s, v2.4s
; CHECK-NEXT:    addp v0.4s, v3.4s, v2.4s
; CHECK-NEXT:    addp v7.4s, v4.4s, v1.4s
; CHECK-NEXT:    rev64 v16.4s, v4.4s
; CHECK-NEXT:    rev64 v17.4s, v3.4s
; CHECK-NEXT:    sub v2.4s, v2.4s, v5.4s
; CHECK-NEXT:    sub v1.4s, v1.4s, v6.4s
; CHECK-NEXT:    rev64 v18.4s, v0.4s
; CHECK-NEXT:    rev64 v19.4s, v7.4s
...
; CHECK-NEXT:    ext v5.16b, v18.16b, v2.16b, #8
; CHECK-NEXT:    ext v16.16b, v19.16b, v1.16b, #8
; CHECK-NEXT:    ext v18.16b, v4.16b, v7.16b, #4
; CHECK-NEXT:    mov v6.s[2], v0.s[3]
; CHECK-NEXT:    mov v17.s[2], v7.s[3]
; CHECK-NEXT:    mov v21.16b, v3.16b
; CHECK-NEXT:    ext v1.16b, v1.16b, v16.16b, #12
; CHECK-NEXT:    zip1 v16.4s, v7.4s, v7.4s
; CHECK-NEXT:    ext v18.16b, v18.16b, v18.16b, #4
; CHECK-NEXT:    mov v19.16b, v6.16b
; CHECK-NEXT:    mov v20.16b, v17.16b
; CHECK-NEXT:    ext v2.16b, v2.16b, v5.16b, #12
; CHECK-NEXT:    ext v5.16b, v3.16b, v0.16b, #8
; CHECK-NEXT:    mov v21.s[2], v0.s[1]
; CHECK-NEXT:    mov v19.s[1], v0.s[2]
; CHECK-NEXT:    mov v20.s[1], v7.s[2]
; CHECK-NEXT:    trn2 v4.4s, v16.4s, v4.4s
; CHECK-NEXT:    mov v16.16b, v18.16b
; CHECK-NEXT:    sub v17.4s, v17.4s, v1.4s
; CHECK-NEXT:    sub v6.4s, v6.4s, v2.4s
; CHECK-NEXT:    ext v3.16b, v5.16b, v3.16b, #4
; CHECK-NEXT:    mov v16.s[0], v7.s[1]
; CHECK-NEXT:    mov v7.16b, v21.16b
; CHECK-NEXT:    add v1.4s, v20.4s, v1.4s
; CHECK-NEXT:    add v2.4s, v19.4s, v2.4s
; CHECK-NEXT:    mov v7.s[1], v0.s[0]
...
; CHECK-NEXT:    sub v5.4s, v21.4s, v0.4s
; CHECK-NEXT:    add v0.4s, v7.4s, v0.4s
; CHECK-NEXT:    mov v4.d[1], v3.d[1]
; CHECK-NEXT:    cmlt v3.8h, v1.8h, #0
...
; CHECK-NEXT:    ldr d1, [x10]
; CHECK-NEXT:    ldr d4, [x11]
; CHECK-NEXT:    ldr d5, [x10, x8]
; CHECK-NEXT:    ldr d6, [x11, x9]
; CHECK-NEXT:    usubl v2.8h, v2.8b, v3.8b
; CHECK-NEXT:    usubl v1.8h, v1.8b, v4.8b
; CHECK-NEXT:    usubl v3.8h, v5.8b, v6.8b
...
; CHECK-NEXT:    trn2 v7.4s, v1.4s, v3.4s
...
; CHECK-NEXT:    mov v6.d[1], v16.d[1]
; CHECK-NEXT:    mov v18.d[1], v2.d[1]
; CHECK-NEXT:    mov v0.d[1], v17.d[1]
; CHECK-NEXT:    uzp2 v1.4s, v5.4s, v1.4s
; CHECK-NEXT:    mov v3.d[1], v2.d[1]
; CHECK-NEXT:    add v4.4s, v7.4s, v6.4s
...
; CHECK-NEXT:    sub v2.4s, v4.4s, v2.4s
; CHECK-NEXT:    zip1 v4.4s, v0.4s, v3.4s
; CHECK-NEXT:    uzp2 v5.4s, v0.4s, v3.4s
; CHECK-NEXT:    zip2 v7.4s, v0.4s, v3.4s
; CHECK-NEXT:    zip1 v6.4s, v2.4s, v1.4s
...
; CHECK-NEXT:    mov v0.s[1], v3.s[1]
; CHECK-NEXT:    ext v2.16b, v2.16b, v6.16b, #8
; CHECK-NEXT:    mov v17.s[3], v1.s[2]
; CHECK-NEXT:    mov v5.d[1], v16.d[1]
; CHECK-NEXT:    mov v0.d[1], v6.d[1]
; CHECK-NEXT:    mov v4.d[1], v2.d[1]
; CHECK-NEXT:    mov v7.d[1], v17.d[1]
; CHECK-NEXT:    add v1.4s, v0.4s, v4.4s
...
; CHECK-NEXT:    zip2 v16.4s, v2.4s, v3.4s
; CHECK-NEXT:    zip2 v17.4s, v3.4s, v2.4s
; CHECK-NEXT:    ext v18.16b, v4.16b, v0.16b, #8
; CHECK-NEXT:    ext v19.16b, v5.16b, v3.16b, #8
; CHECK-NEXT:    zip1 v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    zip1 v1.4s, v2.4s, v3.4s
; CHECK-NEXT:    add v2.4s, v6.4s, v17.4s
; CHECK-NEXT:    sub v3.4s, v16.4s, v7.4s
...
; CHECK-NEXT:    saddw v0.4s, v6.4s, v0.4h
; CHECK-NEXT:    shll2 v3.4s, v2.8h, #16
; CHECK-NEXT:    saddw v1.4s, v7.4s, v1.4h
...
; CHECK-NEXT:    sub v4.4s, v0.4s, v6.4s
...
; CHECK-NEXT:    zip1 v16.4s, v4.4s, v5.4s
; CHECK-NEXT:    sub v6.4s, v3.4s, v6.4s
; CHECK-NEXT:    sub v1.4s, v2.4s, v7.4s
; CHECK-NEXT:    addp v2.4s, v3.4s, v2.4s
; CHECK-NEXT:    ext v3.16b, v0.16b, v0.16b, #8
; CHECK-NEXT:    ext v7.16b, v4.16b, v16.16b, #8
...
; CHECK-NEXT:    uzp1 v6.4s, v2.4s, v3.4s
