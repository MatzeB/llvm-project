...
; AVX1-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0],xmm3[1,2],xmm2[3,4,5,6,7]
...
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0],xmm3[1,2],xmm2[3,4,5,6,7]
...
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3,4,5,6,7]
...
; XOP-NEXT:    vpperm {{.*#+}} xmm0 = xmm1[4,5],xmm0[6,7,14,15],xmm1[6,7,u,u,u,u,u,u,u,u]
...
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[2,3],xmm0[1,2]
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movups (%rsi), %xmm2
; SSE2-NEXT:    movups 16(%rsi), %xmm5
; SSE2-NEXT:    movups (%rdx), %xmm4
; SSE2-NEXT:    movups 16(%rdx), %xmm6
; SSE2-NEXT:    movups (%rcx), %xmm1
; SSE2-NEXT:    movups 16(%rcx), %xmm0
; SSE2-NEXT:    movaps %xmm1, %xmm7
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,1],xmm2[1,3]
; SSE2-NEXT:    movaps %xmm2, %xmm3
; SSE2-NEXT:    unpcklps {{.*#+}} xmm3 = xmm3[0],xmm4[0],xmm3[1],xmm4[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,1],xmm7[0,2]
; SSE2-NEXT:    movaps %xmm5, %xmm7
; SSE2-NEXT:    unpckhpd {{.*#+}} xmm7 = xmm7[1],xmm6[1]
; SSE2-NEXT:    movaps %xmm0, %xmm8
; SSE2-NEXT:    shufps {{.*#+}} xmm8 = xmm8[1,1],xmm6[1,1]
; SSE2-NEXT:    shufps {{.*#+}} xmm8 = xmm8[2,0],xmm7[0,2]
; SSE2-NEXT:    movaps %xmm0, %xmm7
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,1],xmm5[1,3]
; SSE2-NEXT:    movaps %xmm5, %xmm9
; SSE2-NEXT:    unpcklps {{.*#+}} xmm9 = xmm9[0],xmm6[0],xmm9[1],xmm6[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,1],xmm7[0,2]
; SSE2-NEXT:    movaps %xmm2, %xmm7
; SSE2-NEXT:    unpckhpd {{.*#+}} xmm7 = xmm7[1],xmm4[1]
; SSE2-NEXT:    movaps %xmm1, %xmm10
; SSE2-NEXT:    shufps {{.*#+}} xmm10 = xmm10[1,1],xmm4[1,1]
; SSE2-NEXT:    shufps {{.*#+}} xmm10 = xmm10[2,0],xmm7[0,2]
; SSE2-NEXT:    shufps {{.*#+}} xmm5 = xmm5[3,3],xmm6[3,3]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,3],xmm5[1,2]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,2,3,1]
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,3],xmm4[3,3]
; SSE2-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,3],xmm2[1,2]
; SSE2-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,2,3,1]
; SSE2-NEXT:    movups %xmm10, 16(%rdi)
; SSE2-NEXT:    movups %xmm9, 48(%rdi)
; SSE2-NEXT:    movups %xmm8, 64(%rdi)
