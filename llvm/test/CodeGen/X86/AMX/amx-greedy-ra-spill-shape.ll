...
define void @foo(i32 %M, i32 %N, i32 %K, ptr %A, ptr %B_rcr4, ptr %C, i32 %c_row_from, i32 %c_row_to, i32 %c_row_tile, i32 %c_col_from, i32 %c_col_to, i32 %c_col_tile) {
  ...
  ; CHECK-NEXT:   undef %83.sub_32bit:gr64_nosp = COPY $esi
  ...
  ; CHECK-NEXT:   [[CMOV32rr:%[0-9]+]]:gr32 = CMOV32rr [[CMOV32rr]], %82.sub_32bit, 9, implicit $eflags
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[MOV32rm2:%[0-9]+]]:gr32 = MOV32rm %fixed-stack.0, 1, $noreg, 0, $noreg :: (load (s32) from %fixed-stack.0, align 8)
  ...
  ; CHECK-NEXT:   undef %97.sub_32bit:gr64_with_sub_8bit = MOVZX32rr16 %82.sub_16bit
  ; CHECK-NEXT:   MOV64mr %stack.3, 1, $noreg, 0, $noreg, %97 :: (store (s64) into %stack.3)
  ; CHECK-NEXT:   undef %60.sub_32bit:gr64_with_sub_8bit = COPY %97.sub_32bit
  ; CHECK-NEXT:   %60.sub_32bit:gr64_with_sub_8bit = IMUL32rr %60.sub_32bit, %83.sub_32bit, implicit-def dead $eflags
  ; CHECK-NEXT:   [[LEA64_32r:%[0-9]+]]:gr32 = LEA64_32r $noreg, 4, %83, 0, $noreg
  ; CHECK-NEXT:   [[MOVSX64rr32_1:%[0-9]+]]:gr64 = MOVSX64rr32 [[LEA64_32r]]
  ; CHECK-NEXT:   MOV64mr %stack.4, 1, $noreg, 0, $noreg, [[MOVSX64rr32_1]] :: (store (s64) into %stack.4)
  ; CHECK-NEXT:   [[MOVSX64rr32_2:%[0-9]+]]:gr64_nosp = MOVSX64rr32 %83.sub_32bit
  ...
  ; CHECK-NEXT:   MOV64mr %stack.6, 1, $noreg, 0, $noreg, [[MOVSX64rr32_3]] :: (store (s64) into %stack.6)
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:gr64_nosp = COPY [[MOVSX64rr32_3]]
  ...
  ; CHECK-NEXT:   MOV64mr %stack.7, 1, $noreg, 0, $noreg, [[LEA64r]] :: (store (s64) into %stack.7)
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:gr32 = COPY [[MOV32rm2]]
  ; CHECK-NEXT:   MOV16mr %stack.0, 1, $noreg, 20, $noreg, [[COPY2]].sub_16bit :: (store (s512) into %stack.0 + 20, align 4)
  ; CHECK-NEXT:   [[SHL32ri:%[0-9]+]]:gr32 = SHL32ri [[SHL32ri]], 2, implicit-def dead $eflags
  ; CHECK-NEXT:   MOV16mr %stack.0, 1, $noreg, 20, $noreg, [[SHL32ri]].sub_16bit :: (store (s512) into %stack.0 + 20, align 4)
  ; CHECK-NEXT:   [[MOVSX64rr32_4:%[0-9]+]]:gr64 = MOVSX64rr32 [[MOV32rm]]
  ; CHECK-NEXT:   MOV64mr %stack.8, 1, $noreg, 0, $noreg, [[MOVSX64rr32_4]] :: (store (s64) into %stack.8)
  ; CHECK-NEXT:   [[MOVSX64rr32_5:%[0-9]+]]:gr64 = MOVSX64rr32 [[MOV32rm3]]
  ; CHECK-NEXT:   MOV64mr %stack.9, 1, $noreg, 0, $noreg, [[MOVSX64rr32_5]] :: (store (s64) into %stack.9)
  ...
  ; CHECK-NEXT:   [[LEA64_32r1:%[0-9]+]]:gr32 = LEA64_32r %60, 4, [[MOVSX64rm32_]], 0, $noreg
  ; CHECK-NEXT:   MOV32mr %stack.11, 1, $noreg, 0, $noreg, [[LEA64_32r1]] :: (store (s32) into %stack.11)
  ; CHECK-NEXT:   [[MOVSX64rr32_6:%[0-9]+]]:gr64_nosp = MOVSX64rr32 [[MOV32rm2]]
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[MOV32rm4:%[0-9]+]]:gr32 = MOV32rm %fixed-stack.1, 1, $noreg, 0, $noreg :: (load (s32) from %fixed-stack.1, align 16)
  ; CHECK-NEXT:   CMP32mr %fixed-stack.2, 1, $noreg, 0, $noreg, [[MOV32rm4]], implicit-def $eflags :: (load (s32) from %fixed-stack.2, align 8)
  ...
  ; CHECK-NEXT:   [[MOV32rm5:%[0-9]+]]:gr32 = MOV32rm %stack.11, 1, $noreg, 0, $noreg :: (load (s32) from %stack.11)
  ; CHECK-NEXT:   undef %68.sub_32bit:gr64_nosp = COPY [[MOV32rm5]]
  ; CHECK-NEXT:   [[MOV64rm1:%[0-9]+]]:gr64 = MOV64rm %stack.7, 1, $noreg, 0, $noreg :: (load (s64) from %stack.7)
  ...
  ; CHECK-NEXT:   [[ADD64rm1:%[0-9]+]]:gr64 = ADD64rm [[ADD64rm1]], %stack.9, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.9)
  ...
  ; CHECK-NEXT:   ADD64mr %stack.7, 1, $noreg, 0, $noreg, [[MOV64rm3]], implicit-def dead $eflags :: (store (s64) into %stack.7)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   PLDTILECFGV %stack.0, 1, $noreg, 0, $noreg, implicit-def dead $tmm0, implicit-def dead $tmm1, implicit-def dead $tmm2, implicit-def dead $tmm3, implicit-def dead $tmm4, implicit-def dead $tmm5, implicit-def dead $tmm6, implicit-def dead $tmm7 :: (load (s512) from %stack.0, align 4)
  ; CHECK-NEXT:   [[PTILEZEROV:%[0-9]+]]:tile = PTILEZEROV [[MOV32rm3]].sub_16bit, [[MOV32rm2]].sub_16bit
  ; CHECK-NEXT:   [[MOV64rm4:%[0-9]+]]:gr64 = MOV64rm %stack.13, 1, $noreg, 0, $noreg :: (load (s64) from %stack.13)
  ; CHECK-NEXT:   [[PTILELOADDV:%[0-9]+]]:tile = PTILELOADDV [[MOV32rm3]].sub_16bit, [[SUB32rr]].sub_16bit, [[MOV64rm4]], 1, [[MOVSX64rr32_]], 0, $noreg
  ...
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_6]]
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:gr64 = COPY [[MOVSX64rm32_1]]
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:gr32 = COPY [[SHL32ri]]
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:gr32 = COPY [[SUB32rr]]
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:gr32 = COPY [[MOV32rm3]]
  ...
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:gr64_nosp = COPY [[MOV64rm]]
  ; CHECK-NEXT:   [[MOV32rm6:%[0-9]+]]:gr32 = MOV32rm %stack.2, 1, $noreg, 0, $noreg :: (load (s32) from %stack.2)
  ; CHECK-NEXT:   [[PTILELOADDV1:%[0-9]+]]:tile = PTILELOADDV [[MOV32rm6]].sub_16bit, [[COPY7]].sub_16bit, [[LEA64r2]], 1, [[COPY11]], 0, $noreg
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:gr64 = COPY [[COPY11]]
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:gr64 = COPY [[COPY10]]
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:gr32 = COPY [[COPY9]]
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:gr32 = COPY [[COPY8]]
  ; CHECK-NEXT:   [[MOV64rm4:%[0-9]+]]:gr64 = MOV64rm %stack.12, 1, $noreg, 0, $noreg :: (load (s64) from %stack.12)
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]]:gr32 = COPY [[COPY7]]
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:gr64 = COPY [[COPY6]]
  ; CHECK-NEXT:   [[COPY17:%[0-9]+]]:gr64_nosp = COPY [[COPY5]]
  ; CHECK-NEXT:   [[COPY18:%[0-9]+]]:gr64_nosp = COPY [[COPY4]]
  ; CHECK-NEXT:   [[COPY19:%[0-9]+]]:gr64_nosp = COPY [[COPY3]]
  ; CHECK-NEXT:   [[COPY20:%[0-9]+]]:gr32 = COPY [[COPY2]]
  ; CHECK-NEXT:   [[PTDPBSSDV:%[0-9]+]]:tile = PTDPBSSDV [[COPY13]].sub_16bit, [[COPY15]].sub_16bit, [[COPY14]].sub_16bit, [[PTDPBSSDV]], [[PTILELOADDV]], [[PTILELOADDV1]]
  ; CHECK-NEXT:   PTILESTOREDV [[COPY13]].sub_16bit, [[COPY20]].sub_16bit, [[MOV64rm1]], 1, [[COPY18]], 0, $noreg, [[PTDPBSSDV]]
  ; CHECK-NEXT:   [[ADD64rr1:%[0-9]+]]:gr64 = ADD64rr [[ADD64rr1]], [[COPY17]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[ADD64rr2:%[0-9]+]]:gr64 = ADD64rr [[ADD64rr2]], [[MOV64rm4]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[MOVSX64rr32_7]].sub_32bit:gr64_nosp = ADD32rr [[MOVSX64rr32_7]].sub_32bit, [[COPY15]], implicit-def dead $eflags
  ; CHECK-NEXT:   CMP64rr [[ADD64rr1]], [[COPY16]], implicit-def $eflags
