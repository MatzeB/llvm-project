; RUN: llc < %s -mtriple=x86_64-apple-darwin                  -frame-pointer=all -disable-spill-other-class | FileCheck %s
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mcpu=corei7     -frame-pointer=all -disable-spill-other-class | FileCheck --check-prefix=SSE %s
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mcpu=corei7-avx -frame-pointer=all -disable-spill-other-class | FileCheck --check-prefix=AVX %s
