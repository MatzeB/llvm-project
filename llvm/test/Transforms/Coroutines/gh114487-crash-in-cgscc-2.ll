...
entry:
  ...
  %resume.addr = getelementptr inbounds %foo.Frame, ptr %1, i32 0, i32 0
  store ptr @foo.resume, ptr %resume.addr, align 8
  %destroy.addr = getelementptr inbounds %foo.Frame, ptr %1, i32 0, i32 1
...
CoroSave:                                         ; preds = %PostSpill
  %index.addr1 = getelementptr inbounds %foo.Frame, ptr %1, i32 0, i32 2
...
entry:
  ...
  ; CHECK-NEXT: %[[DESTROY_ADDR:.+]] = getelementptr inbounds %foo.Frame, ptr %[[CALLEE_FRAME]], i32 0, i32 1
  ; CHECK-NEXT: store ptr @foo.destroy, ptr %[[DESTROY_ADDR]], align 8
  ; CHECK-NEXT: %[[INDEX_ADDR:.+]] = getelementptr inbounds %foo.Frame, ptr %[[CALLEE_FRAME]], i32 0, i32 2
...
entry:
  ...
  %resume.addr = getelementptr inbounds %foo.Frame, ptr %2, i32 0, i32 0
  store ptr @foo.resume, ptr %resume.addr, align 8
  %destroy.addr = getelementptr inbounds %foo.Frame, ptr %2, i32 0, i32 1
  store ptr @foo.destroy, ptr %destroy.addr, align 8
  br label %AllocaSpillBB
...
CoroSave:                                         ; preds = %PostSpill
  %index.addr1 = getelementptr inbounds %foo.Frame, ptr %2, i32 0, i32 2
  store i1 false, ptr %index.addr1, align 1
  br label %CoroSuspend
